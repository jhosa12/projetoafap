...
const DeclaracaoExclusao =forwardRef<HTMLDivElement, DadosProps>(({
    bairro,
    cidade,
    contrato,
    cpf,
    ...
    return (
        <div ref={ref} className='relative flex flex-col h-screen w-full p-2 '>
            <div className="flex  w-full justify-center items-center mt-4">
                <img width={100} height={70} src={logoUrl} alt="logo" />
            </div>
