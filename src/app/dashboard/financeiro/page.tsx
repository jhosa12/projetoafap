...
export default function LoginFinaceiro() {
  ...
  return (
    ...
    <div className="flex flex-col  w-full text-white">
      <Tabs onActiveTabChange={e => setTabIndex(e)} theme={{
        base: 'bg-white rounded-b-lg', tabpanel: 'bg-white rounded-b-lg h-[calc(100vh-104px)]', tablist: {
          tabitem: {
            base: "flex items-center text-xs justify-center  px-4 py-3  font-medium first:ml-0  disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500", variant: {
              underline: {
                active: {
