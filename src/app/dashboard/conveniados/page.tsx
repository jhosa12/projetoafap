...
import { useActionsConveniados } from "./_hooks/useActionsConveniados";
...
export default function Conveniados() {
  ...
  const { listarConveniados, conveniados, setConveniados } = useActionsConveniados()
  ...
  return (
    <>
      ...
      <div className="bg-white h-[calc(100vh-59px)] flex flex-col p-2 ">
        <Button onClick={() => {
          setOpenNovoConveniado(true), setConveniado({
            conveniado: '',
            fone: '',
            endereco: '',
            filename: '',
