...
import { Acompanhamento, SetorProps } from "@/app/dashboard/vendas/_components/acompanhamento"
...
export default function Vendas() {
  ...
  return (
    <>
      ...
      <Tabs theme={{
        base: 'bg-white rounded-b-lg', tabpanel: 'w-full bg-white rounded-b-lg h-[calc(100vh-100px)]', tablist: {
          tabitem: {
            base: "flex items-center  justify-center px-4 py-3 text-xs font-medium first:ml-0  disabled:cursor-not-allowed disabled:text-gray-400 ", variant: {
              underline: {
                active: {
