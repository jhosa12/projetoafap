...
import CadastroPremio from "../_config/cadastroPremio"
import ConsultarGanhadores from "../_config/consultar"
...
export default function ConfigSort() {
  ...
  return (
    <div className="flex flex-col  w-full text-white">
      <Tabs theme={{
        base: 'bg-white rounded-b-lg', tabpanel: 'bg-white rounded-b-lg h-[calc(100vh-105px)]', tablist: {
          tabitem: {
