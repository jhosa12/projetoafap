...
import { HistoricoProps } from "@/app/dashboard/estoque/components/historico/historico";
...
const RelatorioMov = forwardRef<HTMLDivElement, DadosProps>(({ dados }, ref) => {
  return (
    <div ref={ref} className={`${roboto_Mono.className} flex flex-col w-full p-2   gap-5`}>
...
RelatorioMov.displayName = "RelatorioMov";
