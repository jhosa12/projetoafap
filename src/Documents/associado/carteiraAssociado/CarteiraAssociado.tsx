      ...
      <div className="flex flex-col w-full ">
        <div className="grid  grid-cols-2 grid-rows-5 w-full justify-items-center gap-1">
          ...
          <Image alt={'carteiraDep'} height={210} width={362} src={titularVerso} className="object-cover " />*/}
              <img
                src={
                  infoEmpresa?.nome !== "VIVA MAIS"
                    ? `/cartoes/cartaoFuneraria.webp`
                    : "/frenteverso.png"
                }
                alt="Fundo do carnê"
                fetchPriority="high"
              ...
              <div
                ...
                className={`${infoEmpresa?.nome!=='VIVA MAIS'?`text-white`:"text-black"} `}
              >
              ...
              >
                <h1 style={{ fontSize: 10, gridColumn: "1 / -1" }}>
                  {titular}
                </h1>
                ...
                <span>
                  {" "}
                  {adesao
                    ? new Date(adesao).toLocaleDateString("pt-BR", {
                        timeZone: "UTC",
                      })
                    : "."}
                </span>
              ...
              return (
                ...
                >
                  <img
                    src={
                      infoEmpresa?.nome !== "VIVA MAIS"
                        ? `/cartoes/cartaoDependenteFuneraria.webp`
                        : "/dependenteCartao.png"
                    }
                    alt="dependente"
                    fetchPriority="high"
                    style={{
                  ...
                  >
                    ...
                    <span>
                      {" "}
                      {item.data_nasc
                        ? new Date(item.data_nasc).toLocaleDateString("pt-BR", {
                            timeZone: "UTC",
                          })
                        : "."}
                    </span>
                    ...
                    <span>
                      {" "}
                      {item.carencia &&
                        new Date(item.carencia).toLocaleDateString("pt-BR", {
                          timeZone: "UTC",
                        })}
                    </span>
                  </div>
