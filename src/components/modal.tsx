...
export function ModalBusca({nome,closeModal,updateFields}:UserFormProps){
   ...
   <div  className="absolute w-screen h-[100vh] max-h-full">
    <div className=" justify-center p-2 w-full h-2/3 ">
    ...
    <button onClick={()=>setDrop(!dropOpen)} className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">{criterio} 
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
      ...
      {dropOpen && (
          ...
          <li >
              <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={()=>{setCriterio('Contrato'),setDrop(false)}}>Contrato</a>
          </li>
          <li>
              <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={()=>{setCriterio('Titular'),setDrop(false)}}>Titular</a>
          </li>
          <li>
              <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={()=>{setCriterio('Dependente'),setDrop(false)}}>Dependente</a>
          </li>
          <li>
              <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"  onClick={()=>{setCriterio('Endereço'),setDrop(false)}}>Endereço</a>
          </li>
          </ul>
      </div>
      )}
        <div className="relative  w-full">
            <input type="search" id="search-dropdown" className="flex justify-center  p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search" required/>
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
            ...
            <div className="flex flex-col overflow-y-auto mb-1 p-2 md:p-2">
                <p className="text-gray-500 dark:text-gray-400 mb-2">Selecione o Contrato:</p>
                <ul className="overflow-y-visible space-y-2 mb-2">
                    <li onClick={()=>updateFields({closeModal:false})}>
                        <label  className="inline-flex items-center justify-between w-full p-2 text-gray-900  rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600  dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">                           
                            <div className="block">
