...
<div  className={`fixed  rounded-e-lg z-40 top-[65px] left-0 w-64 h-[calc(100vh-60px)] p-4 overflow-y-auto bg-gray-800 transition-transform ${isOpen ? "" : "transform -translate-x-full"}`}>
  ...
  <div className="py-4 overflow-y-auto">
    ...
    <li>
        ...
        <li>
            <Link href='/testeprint' onClick={()=>setIsOpen(false)} className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Teste Print</Link>
        </li>
