...
import useActionsPerfil from "@/hooks/usuarios/useActionsPerfil";
...
export function ModalNovoPerfil({ isOpen, onClose, id, perfis,onDataReload }: ModalNovoPerfilProps) {
