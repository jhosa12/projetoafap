   ...
   async function editar(id_ideia:number){
    ...
    return(
        <div className="flex w-full h-screen ml-2 mt-2 gap-2 ">
            ...
            <textarea rows={8} value={descricao} onChange={e=>setDescricao(e.target.value)} placeholder="Digite aqui as ideias e sugestões!" className=" h-2/3 text-sm p-2 rounded-lg  border-0 bg-gray-800 focus:ring-0 text-white placeholder-gray-400" />
