...
export default function AdministrarEstoque(){
    ...
    return(
      ...
      <Tabs  theme={{base: 'bg-white rounded-b-lg',tabpanel:'bg-white rounded-b-lg h-[calc(100vh-104px)] px-2',tablist:{tabitem:{base: "flex items-center text-xs justify-center rounded-t-lg px-4 py-3  font-medium first:ml-0  disabled:cursor-not-allowed disabled:text-gray-400 ",variant:{underline:{active:{
