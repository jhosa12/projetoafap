...
import { Acompanhamento } from "@/components/vendas/acompanhamento"
    ...
    <>
      ...
      <div className="flex flex-col w-full text-white">
        <Tabs theme={{
          ...
          <Tabs.Item active={tab === 0} title="Acompanhamento" icon={FaStore}>
            {tab === 0 && <Acompanhamento empresa={selectEmp} />}

          </Tabs.Item>
          <Tabs.Item active={tab === 1} title="Histórico" icon={RiHistoryLine}>
            {tab === 1 &&
              <Suspense fallback={<div>Carregando...</div>}>
                <Historico />
              </Suspense>}
          </Tabs.Item>
          <Tabs.Item active={tab === 0} title="METAS" icon={GoGoal}>
            <MetasVendas />
          </Tabs.Item>
