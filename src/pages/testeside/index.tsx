...
<div  className={`fixed  rounded-e-lg z-40 top-[65px] left-0 w-64 h-screen p-4 overflow-y-auto bg-gray-800 transition-transform ${!isOpen ? "" : "transform -translate-x-full"}`}>
