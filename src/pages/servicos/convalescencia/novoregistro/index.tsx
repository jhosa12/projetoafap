                    ...
                    {material && <div className="flex flex-col w-full rounded-lg p-6   gap-5">
                        <div className="flex flex-row text-white gap-6 w-full">
                            ...
                            <div>
                                ...
                                <select value={(listaMaterial.descricao)} onChange={e => setarMaterialLista({ descricao: e.target.value.toUpperCase() })} className="block uppercase w-full pb-1 pt-1 pr-2 pl-2 sm:text-sm border  rounded-lg bg-gray-50  dark:bg-gray-700 border-gray-600 placeholder-gray-400 text-white " >
                                    <option></option>
                                    {
                                    ...
                                    {listaConv.convalescenca_prod?.map((item, index) => {
                                        return (<tr key={index} className={`border-b bg-gray-800 border-gray-700  hover:bg-gray-600`}>
                                            ...
                                            <td className="px-4 py-1 flex justify-center text-center ">
                                                <button onClick={() => {
                                                    const novo = listaConv.convalescenca_prod && [...listaConv.convalescenca_prod]
                                                    novo?.splice(index, 1)
                                                    setarListaConv({ convalescenca_prod: novo })
